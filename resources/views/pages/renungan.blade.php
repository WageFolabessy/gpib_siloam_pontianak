...
@section('content')
    <div class="speakable" id="renungan-header-section">
        <div class="container mt-5">
            <div class="p-5 mb-4 bg-light rounded-3 text-center shadow-sm">
                <h1 class="display-6"><span class="tts-segment">Renungan</span></h1>
                <p class="lead"><span class="tts-segment">Dalam pelukan hangat renungan rohani ini. Semoga setiap kata yang
                        ...
                        kita.</span></p>
                <hr class="my-4" />
                <p><span class="tts-segment">Tuhan memberkati perjalanan rohaniah kita bersama!</span></p>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-4">
        ...
        <div id="load-more-container" class="text-center mt-3 mb-5 {{ !$renungan->hasMorePages() ? 'd-none' : '' }}">
            <button id="load-more" class="btn btn-outline-primary px-4 py-2"
